...
void RedGhost::setTexture()
{
	m_MonsterTexture = TextureHolder::GetTexture("graphics/monsters/red_ghost.png");
}


void RedGhost::setStartFeatures()
{
	m_MaxHealth = 150;
	...
	m_MinPower = 5;
	m_MaxPower = 10;
	individualCorrection = 1130 + 30*m_GhostNumber;
	if (m_GhostNumber % 2 == 0)
	{
		m_TimeToShoot = 4;
	}
	...
	m_StopCorrection = 30 * ghostNumber;
	m_CanStopTeddy = true;
	timeToHit = 1;
}


Vector2f RedGhost::spellStartPosition()
{
	Vector2f start;
